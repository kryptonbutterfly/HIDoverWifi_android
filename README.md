...
In order to setup it's best to start with setting up the service first and come back to the setup of the app afterwards. [setup Service](https://github.com/kryptonbutterfly/HIDoverWifi_service#setup)
...
* start the app
* Add a new device:
    * Set `Device name` to the name of your pc
